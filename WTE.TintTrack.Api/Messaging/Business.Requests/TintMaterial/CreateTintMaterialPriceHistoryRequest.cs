...
public class CreateTintMaterialPriceHistoryRequest : IEntityCreateRequest, ICodedModel
{
    /*[Required]
    ...
    public required string Description { get; set; } // Detailed description of the TintMaterial
