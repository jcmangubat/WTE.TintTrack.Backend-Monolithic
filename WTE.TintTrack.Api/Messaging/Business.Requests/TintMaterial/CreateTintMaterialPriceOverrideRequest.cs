...
public class CreateTintMaterialPriceOverrideRequest : IEntityCreateRequest, ICodedModel
{
    /*[Required]
    [MaxLength(FieldLengths.Customer.Code)]*/
    public required string Code { get; set; }
    public required string Name { get; set; } // Name of the tint material (e.g., "Solar Tint Film")
    public required string Description { get; set; } // Detailed description of the tint material
