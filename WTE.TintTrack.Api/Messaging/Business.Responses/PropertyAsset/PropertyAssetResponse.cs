...
namespace WTE.TintTrack.Api.Messaging.Business.Responses.PropertyAsset;
...
public class PropertyAssetResponse : ApiMessageResponse, ICodedModel, IEntityResponse
{
