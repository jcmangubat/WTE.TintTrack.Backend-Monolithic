...
namespace WTE.TintTrack.Api.Messaging.Business.Responses.TintMaterial;

public class  TintMaterialPriceScheduleResponse : ApiMessageResponse, ICodedModel, IEntityResponse
{
