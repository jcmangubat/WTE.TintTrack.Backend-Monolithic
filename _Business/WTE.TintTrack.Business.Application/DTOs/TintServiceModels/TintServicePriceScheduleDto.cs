...
public class TintServicePriceScheduleDto : GuidKeyedAuditableModel
{
    ...
    public ICollection<TintServicePriceTierDto> TintServicePriceTiers { get; set; } = new HashSet<TintServicePriceTierDto>();
    public ICollection<TintServicePriceOverrideDto> TintServicePriceOverrides { get; set; } = new HashSet<TintServicePriceOverrideDto>();
}
