...
public class ProposalDto : GuidKeyedAuditableModel, ICodedEntity
{
    ...
    public virtual IEnumerable<ProposalItemDto> ProposalItems { get; set; } = [];
    public virtual IEnumerable<CommercialOfferRecipientDto> CommercialOfferRecipients { get; set; } = [];
    public virtual IEnumerable<WorkOrderDto> WorkOrders { get; set; } = [];
    public virtual IEnumerable<ProjectMilestoneDto> ProjectMilestones { get; set; } = [];
}
