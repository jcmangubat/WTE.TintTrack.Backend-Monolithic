...
using WTE.TintTrack.Business.Domain.Entities.CommercialOffers;
using WTE.TintTrack.Domain.Shared;
using static WTE.TintTrack.Common.Constants.Consts;

namespace WTE.TintTrack.Business.Application.DTOs.old.SalesAndQuoting;

public class ContractDto : GuidKeyedAuditableEntity, ICodedEntity
{
    ...
    public ICollection<ContractMilestoneDto> ContractMilestones { get; set; } = new HashSet<ContractMilestoneDto>();
}
