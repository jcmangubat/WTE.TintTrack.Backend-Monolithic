...
namespace WTE.TintTrack.Business.Infrastructure.DataPersistence.Migrations
{
    ...
    [Migration("20241108075141_AddedContactCode")]
    partial class AddedContactCode
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.AuditLog", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2024, 11, 8, 15, 51, 40, 639, DateTimeKind.Local).AddTicks(7602))
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Contact", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2024, 11, 8, 15, 51, 40, 639, DateTimeKind.Local).AddTicks(9745))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.ContactOwnership", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2024, 11, 8, 15, 51, 40, 640, DateTimeKind.Local).AddTicks(3417))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
