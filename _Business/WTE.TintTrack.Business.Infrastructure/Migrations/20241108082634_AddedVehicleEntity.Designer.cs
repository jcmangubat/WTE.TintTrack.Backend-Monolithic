...
namespace WTE.TintTrack.Business.Infrastructure.DataPersistence.Migrations
{
    ...
    [Migration("20241108082634_AddedVehicleEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.AuditLog", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2024, 11, 8, 16, 26, 34, 82, DateTimeKind.Local).AddTicks(6672))
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Contact", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2024, 11, 8, 16, 26, 34, 82, DateTimeKind.Local).AddTicks(8779))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.ContactOwnership", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2024, 11, 8, 16, 26, 34, 83, DateTimeKind.Local).AddTicks(2571))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Vehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Vehicle", b =>
                {
                    b.HasOne("WTE.TintTrack.Business.Domain.Entities.Contact", "OwnerContact")
                        .WithMany("Vehicles")
