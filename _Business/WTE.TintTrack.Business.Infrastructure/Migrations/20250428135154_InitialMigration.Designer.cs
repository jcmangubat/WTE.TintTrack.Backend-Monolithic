...
namespace WTE.TintTrack.Business.Infrastructure.Migrations
{
    ...
    [Migration("20250428135154_InitialMigration")]
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Address", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 50, DateTimeKind.Local).AddTicks(1880))
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.AuditLog", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 33, DateTimeKind.Local).AddTicks(9372))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.CommercialOffersEntities.Estimate", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 72, DateTimeKind.Local).AddTicks(9910))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.CommercialOffersEntities.Proposal", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 75, DateTimeKind.Local).AddTicks(1376))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.CommercialOffersEntities.Quote", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 70, DateTimeKind.Local).AddTicks(8380))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Contact", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 42, DateTimeKind.Local).AddTicks(4609))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 37, DateTimeKind.Local).AddTicks(8929))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.CustomerContact", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 44, DateTimeKind.Local).AddTicks(2089))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Inquiry", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 54, DateTimeKind.Local).AddTicks(5778))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.PropertyAsset", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 45, DateTimeKind.Local).AddTicks(7472))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterial", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 57, DateTimeKind.Local).AddTicks(2734))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterialPriceHistory", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 59, DateTimeKind.Local).AddTicks(7720))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterialPriceOverride", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 60, DateTimeKind.Local).AddTicks(4924))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterialPriceSchedule", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 61, DateTimeKind.Local).AddTicks(9389))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterialPriceTier", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 69, DateTimeKind.Local).AddTicks(1424))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintServiceEntities.TintService", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 21, 51, 54, 51, DateTimeKind.Local).AddTicks(4925))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
