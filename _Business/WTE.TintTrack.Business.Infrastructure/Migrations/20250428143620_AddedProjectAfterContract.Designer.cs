...
namespace WTE.TintTrack.Business.Infrastructure.Migrations
{
    ...
    [Migration("20250428143620_AddedProjectAfterContract")]
    partial class AddedProjectAfterContract
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Address", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 636, DateTimeKind.Local).AddTicks(9926))
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.AuditLog", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 621, DateTimeKind.Local).AddTicks(509))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.CommercialOffersEntities.Estimate", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 659, DateTimeKind.Local).AddTicks(5640))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.CommercialOffersEntities.Proposal", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 662, DateTimeKind.Local).AddTicks(6691))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.CommercialOffersEntities.Quote", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 656, DateTimeKind.Local).AddTicks(177))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Contact", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 629, DateTimeKind.Local).AddTicks(6261))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 624, DateTimeKind.Local).AddTicks(9588))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.CustomerContact", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 631, DateTimeKind.Local).AddTicks(4667))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Inquiry", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 641, DateTimeKind.Local).AddTicks(3175))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.PropertyAsset", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 632, DateTimeKind.Local).AddTicks(8574))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.SalesAndQuotingEntities.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 668, DateTimeKind.Local).AddTicks(7285))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.SalesAndQuotingEntities.Project", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 678, DateTimeKind.Local).AddTicks(7650))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.SalesAndQuotingEntities.ProjectMilestone", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 681, DateTimeKind.Local).AddTicks(8465))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterial", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 643, DateTimeKind.Local).AddTicks(7970))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterialPriceHistory", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 646, DateTimeKind.Local).AddTicks(2828))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterialPriceOverride", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 647, DateTimeKind.Local).AddTicks(1381))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterialPriceSchedule", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 648, DateTimeKind.Local).AddTicks(4383))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterialPriceTier", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 653, DateTimeKind.Local).AddTicks(2056))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintServiceEntities.TintService", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 22, 36, 18, 638, DateTimeKind.Local).AddTicks(5318))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
