...
namespace WTE.TintTrack.Business.Infrastructure.Migrations
{
    ...
    [Migration("20250428150259_LinkedServicesAndMaterialsToOffers2")]
    partial class LinkedServicesAndMaterialsToOffers2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Address", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 171, DateTimeKind.Local).AddTicks(8664))
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.AuditLog", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 148, DateTimeKind.Local).AddTicks(1396))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.CommercialOffersEntities.Estimate", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 206, DateTimeKind.Local).AddTicks(9810))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.CommercialOffersEntities.Proposal", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 211, DateTimeKind.Local).AddTicks(1144))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.CommercialOffersEntities.Quote", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 202, DateTimeKind.Local).AddTicks(4707))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Contact", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 161, DateTimeKind.Local).AddTicks(1548))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 154, DateTimeKind.Local).AddTicks(1855))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.CustomerContact", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 163, DateTimeKind.Local).AddTicks(4494))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.Inquiry", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 181, DateTimeKind.Local).AddTicks(5134))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.PropertyAsset", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 165, DateTimeKind.Local).AddTicks(5614))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.SalesAndQuotingEntities.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 219, DateTimeKind.Local).AddTicks(3421))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.SalesAndQuotingEntities.Project", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 234, DateTimeKind.Local).AddTicks(3941))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.SalesAndQuotingEntities.ProjectMilestone", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 237, DateTimeKind.Local).AddTicks(8671))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterial", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 186, DateTimeKind.Local).AddTicks(8953))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterialPriceHistory", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 190, DateTimeKind.Local).AddTicks(8989))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterialPriceOverride", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 191, DateTimeKind.Local).AddTicks(8696))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterialPriceSchedule", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 193, DateTimeKind.Local).AddTicks(5614))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintMaterialEntities.TintMaterialPriceTier", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 199, DateTimeKind.Local).AddTicks(9700))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("WTE.TintTrack.Business.Domain.Entities.TintServiceEntities.TintService", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 23, 2, 58, 175, DateTimeKind.Local).AddTicks(6391))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
