...
public class TintMaterialPriceTierRepository(TenantDbContext dbContext) : RepositoryForGuidKeyedEntity<TintMaterialPriceTier>(dbContext), ITintMaterialPriceTierRepository { }